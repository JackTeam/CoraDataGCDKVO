...
@property (strong, nonatomic) NSManagedObjectContext *newManagedObjectContext;
...
- (NSManagedObjectContext *)newManagedObjectContext {
    if (_newManagedObjectContext != nil) {
        return _newManagedObjectContext;
    }
    
    NSManagedObjectContext *masterContext = [self masterManagedObjectContext];
    if (masterContext != nil) {
        _newManagedObjectContext = [[NSManagedObjectContext alloc] initWithConcurrencyType:NSMainQueueConcurrencyType];
        [_newManagedObjectContext performBlockAndWait:^{
            [_newManagedObjectContext setParentContext:masterContext];
        }];
    }
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"CoraDataGCDKVO" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"CoreDataGCDKVO.sqlite"];
